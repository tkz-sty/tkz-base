...
See the section "The  Quotes Syntax" in the \TIKZ\ manual.
...
\medskip
Warning at the final "s", an oversight leads to cascading errors if you attempt
...
\begin{NewMacroBox}{tkzDefSetOfPoints}{\oarg{local
options}\var{$x_1/y_1,x_2/y_2,\ldots,x_n/y_n$}}%
\begin{tabular}{lll}%
arguments &  default & definition  \\
\midrule
