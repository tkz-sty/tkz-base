...
\item \tkzimp{Why \tkzNamePack{tkz-base}?}
...
\item \tkzimp{Relationship with \TIKZ?}
...
\item \tkzimp{Error unknown option: \enquote{label options}}
...
\item \tkzimp{Propagation of a style}
...
\item \tkzimp{The use of the comma}
