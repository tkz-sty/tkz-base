...
Of course you can use \TIKZ, but the macro I propose to allow you to place the
text using the units chosen for the drawing.
...
The option \tkzname{text width} is interesting, see the pgfmanual for more
information.
