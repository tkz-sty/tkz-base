...
\subsection{Coordinate system with \tkzcname{tkzRep}}\hypertarget{rep}{}
...
For those who use \tkzname{french} with \tkzname{babel}, in case of problems
with version 3 of pgf, just load the \tkzname{babel} library. \TIKZ\ was indeed
sometimes allergic to the active characters.
