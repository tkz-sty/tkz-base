...
\subsection{Horizontal lines with \tkzcname{tkzHLines}}\hypertarget{thls}{}
...
arguments &  example & definition  \\
\midrule
\TAline{list of values}{\tkzcname{tkzHLines\{1,4\}}}{draws the lines $y=1$ and
$y=4$}
\end{tabular}
\end{NewMacroBox}
...
\subsection{Vertical lines with \tkzcname{tkzVLines}}\hypertarget{tvls}{}
...
arguments &  example & definition  \\
\midrule
\TAline{list of values}{\tkzcname{tkzVLines\{1,4\}}}{Trace the lines $x=$1 and
$x=4$}
\end{tabular}
\end{NewMacroBox}
...
arguments &  example & definition  \\
\midrule
\TAline{decimal number}{\tkzcname{tkzHTicks\{1\}}}{the abscissa of the tick is
1}
\bottomrule
\end{tabular}
